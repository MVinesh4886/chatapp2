...
const RegisterUser = async (req, res) => {
  ...
  try {
    ...
    const mailOptions = {
      ...
      text: `Please verify your email by clicking the following link: http://54.196.136.82:8000/user/verifyEmail/${Token}`,
    };
...
const ForgotPassword = async (req, res) => {
  ...
  try {
    ...
    const mailOptions = {
      ...
      text: `http://127.0.0.1:5500/Frontend/resetPassword.html`,
    };
